            ...
            >
                <div class="create-event-form">
                    ...
                    <div class="form-row with-icon" style="${i?"display: none":""}">
                        ...
                        <input type="time" id="event-start-time" class="form-input" .value="${s}" required />
                    </div>
                    <div class="form-row">
