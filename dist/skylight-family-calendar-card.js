            ...
            ${i.map(e=>{let i=[e.colors[0]],a=!t&&"banner"===this._multiDayMode&&e.multiDay,n=e.multiDayPosition??"middle",r=a?" banner"+(a&&"start"!==n&&!s?" ljoin":"")+(a&&"end"!==n&&!l?" rjoin":""):"",o=!a||"start"===n||s,d=this._eventMarker(e),c=this._resolveCalendarIcon(this._calByEntity[e.calendars&&e.calendars[0]]);return P`
                    ...
                    >
                        ...
                        <div class="inner">
                            ...
                            ${t&&this._eventMeta(e)?P`<div class="event-meta" style="${"familial"===this._theme?"color: "+this._metaColor(e):""}">${this._eventMeta(e)}</div>`:""}
