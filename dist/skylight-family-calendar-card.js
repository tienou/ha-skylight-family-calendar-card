        ...
        `:j``}_renderEvents(e){let t=[];if(e.events.map(e=>{if(!this._calendarEvents[e])return;let n=Object.assign({},this._calendarEvents[e]),i=[...n.calendars],a=[...n.colors],r=0;for(;r<i.length;)this._hideCalendars.indexOf(i[r])>-1?(i.splice(r,1),a.splice(r,1)):r++;0!==i.length&&(n.calendars=i,n.colors=a,t.push(n))}),0===t.length)return this._renderNoEvents();let n=!1;return this._maxDayEvents>0&&t.length>this._maxDayEvents&&(t.splice(this._maxDayEvents),n=!0),j`
            ${t.map(e=>{let t=[e.colors[0]];return j`
                    <div
                        ...
                        style="--border-color: ${e.colors[0]}; --event-bg-tint: ${e.colors[0]}; --dot-color: ${e.colors[0]}${this._colorFullEvent&&"skylight"!==this._theme?"; background-color: "+e.colors[0]+"; color: #fff; border-left-width: 0":""}"
                    ...
                    >
                        ...
                        <div class="inner">
                            ${"skylight"===this._theme?j`
                                    ${this._showEventTitle?j`<div class="title">${e.summary}</div>`:""}
                                    ${this._showTime?j`<div class="time">${this._renderEventTime(e)}</div>`:""}
                                `:j`
                                    ${this._showTime?j`<div class="time">${this._renderEventTime(e)}</div>`:""}
                                    ${this._showEventTitle?j`<div class="title">${e.summary}</div>`:""}
                                `}
                        ...
                        ${e.icon?j`
                            ...
                            `:""}
                        ${"skylight"===this._theme?j`<div class="calendar-dot"></div>`:""}
                    </div>
                `})}
            ${n?j`
                    <div class="more">
