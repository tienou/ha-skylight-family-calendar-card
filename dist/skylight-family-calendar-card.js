            ...
            >
                <div class="create-event-form">
                    ...
                    <div class="form-row location-row">
                        ...
                        ${e.location?j`
                        <a class="location-maps-link" href="${this._locationLink}${encodeURI(e.location)}" target="_blank">
