            ...
            >
                <div class="create-event-form">
                    ...
                    <div class="form-row with-icon" style="${i?"display: none":""}">
                        ...
                        <input type="text" id="event-start-time" class="form-input" required placeholder="8:30" .value="${s}"
                            @change="${e=>{let t=this._parseTime(e.target.value);t&&(e.target.value=t)}}" />
                    </div>
                    <div class="form-row">
